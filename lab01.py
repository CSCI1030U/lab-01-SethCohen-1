def main():
    ...
    # Error description (not printed): TypeError occurred because of attempting to concatenate str and float.
    ...
    investment += investment * interest_rate
    investment += investment * interest_rate
    # Convert float to string for concatenation (no f-string as per instructions)
